import type { Herb, Potion, ExtremeRecipe } from "./types";
...
export const otherPotionRecipes = {
	prayer_renewal: {
		herb: "fellstalk",
...
export const getDefaultInventory = () => {
	return {
		...
		extremePotions: extremePotions.reduce((acc, potion) => ({ ...acc, [potion.id]: 0 }), {}),
	};
};
